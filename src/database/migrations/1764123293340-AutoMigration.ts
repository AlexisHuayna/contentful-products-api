...
export class AutoMigration1764123293340 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE INDEX "IDX_078766bd87e61a8a249a966766" ON "products" ("externalId") `);
        await queryRunner.query(`CREATE INDEX "IDX_fe52498d76ba7545ad5b2553c0" ON "products" ("model") `);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_fe52498d76ba7545ad5b2553c0"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_078766bd87e61a8a249a966766"`);
