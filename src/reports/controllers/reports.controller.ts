...
export class ReportsController {
    ...
    @ApiOkResponse({ type: ApiResponseDto<ReportDeletedPercentageResponseDto>, description: 'Deleted percentage response' })
    ...
    @ApiOkResponse({ type: ApiResponseDto<ReportActivePercentageResponseDto>, description: 'Active percentage response' })
    @ApiQuery({ type: ReportsActiveAvg, name: 'query', description: 'Parameters for active percentage' })
    ...
    @ApiOkResponse({ type: ApiResponseDto<ReportAvgPriceByCategoryResponseDto[]>, description: 'Average price by category response' })
